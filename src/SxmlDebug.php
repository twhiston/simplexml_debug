...
class SxmlDebug {
  ...
  private static function AddNamespace($item, &$dump) {
  ...
  public static function dump(\SimpleXMLElement $sxml) {
    ...
    while (isset($sxml[$item_index])) {
      ...
      if (dom_import_simplexml($item) instanceOf \DOMAttr) {
        ...
        $dump .= self::INDENT . self::INDENT . 'Name: \'' . $item->getName() .
                 '\'' .
                 PHP_EOL;
        $dump .= self::INDENT . self::INDENT . 'Value: \'' . (string) $item .
                 '\'' .
                 PHP_EOL;
        ...
        $dump .= self::INDENT . self::INDENT . 'String Content: \'' .
                 (string) $item .
                 '\'' . PHP_EOL;
        ...
        foreach ($all_ns as $ns_alias => $ns_uri) {
          ...
          if (!is_null($ns_uri)) {
            $dump .= self::INDENT . self::INDENT . self::INDENT .
                     'Namespace URI: \'' .
                     $ns_uri .
                     '\'' . PHP_EOL;
          }
          ...
          $dump .= self::INDENT . self::INDENT . self::INDENT . 'Children: ' .
                   count($children);
          ...
          $dump .= self::INDENT . self::INDENT . self::INDENT . 'Attributes: ' .
                   count($attributes);
